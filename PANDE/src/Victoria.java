...
public class Victoria extends JFrame implements ActionListener { 
	public int idJugador;
	public JTextArea textArea;
public Victoria(int idpartida) {
ranking(idpartida);
    ...
    try {
		...
		con = DriverManager.getConnection(DB_URL, USER, PASS);
		 System.out.println("Insertando el nuevo jugador en nuestra bd");
            ...
            String sql = "INSERT INTO ranking (id, rondassuperadas, nombrepartida, fecha, resultado) VALUES ( ranking_seq.NEXTVAL, (SELECT rondasjugadas FROM partida WHERE idpartida = "+idpartida+"), (SELECT nombrepartida FROM partida WHERE idpartida = "+idpartida+"), SYSDATE, 'Ganador' )";
